...
// icmpReasonCantFragment is an error where a packet requires
// fragmentation while also having the Don't Fragment flag set, as per
// RFC 792 page 3, Destination Unreachable Message.
type icmpReasonCantFragment struct{}

func (*icmpReasonCantFragment) isICMPReason() {}
func (*icmpReasonCantFragment) isForwarding() bool {
	// If we hit a Can't Fragment error, then we know we are operating as a router.
